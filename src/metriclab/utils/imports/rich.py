...
def check_rich() -> None:
    ...
    Example:
        ```pycon
        >>> from metriclab.utils.imports import check_rich
        >>> try:
        ...     check_rich()
        ... except RuntimeError:
        ...     pass
...
def is_rich_available() -> bool:
    ...
    Example:
        ```pycon
        >>> from metriclab.utils.imports import is_rich_available
        >>> is_rich_available()
...
def rich_available(fn: F) -> F:
    ...
    Example:
        ```pycon
        >>> from metriclab.utils.imports import rich_available
        >>> @rich_available
...
def raise_rich_missing_error() -> NoReturn:
    ...
    Example:
        ```pycon
        >>> from metriclab.utils.imports import raise_rich_missing_error
        >>> try:
        ...     raise_rich_missing_error()
