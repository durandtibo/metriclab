    ...
    *,
    ...
    Args:
        ...
        missing_policy: The policy for handling missing values.
            ...
            ``balanced_accuracy=nan`` when missing values are
    ...
    Returns:
        The balanced accuracy result. When missing values are present
            and ``missing_policy='propagate'``, the result keeps
            ``num_predictions`` and sets ``balanced_accuracy`` to
            ``nan``.
