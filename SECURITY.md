...
The `metriclab` team takes security bugs seriously. We appreciate your efforts to responsibly disclose
your findings.
...
When using `metriclab` in your projects:

1. **Keep dependencies updated**: Regularly update to the latest version of `metriclab` and its
   dependencies
...
`metriclab` is a library for comparing complex objects. When using it:
...
- **Third-party data structures**: When extending `metriclab` to support custom types, ensure proper
